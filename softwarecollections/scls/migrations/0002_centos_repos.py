...
class Migration(migrations.Migration):
    ...
    dependencies = [("scls", "0001_initial")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.CharField(verbose_name="CentOS version", max_length=20),
                ),
                ...
                (
                    "release_package",
                    models.CharField(
                        verbose_name="Release package name", max_length=100
                    ),
                ),
                (
                    "last_modified",
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                to="scls.Copr", verbose_name="Copr projects", blank=True
            ),
        ),
        migrations.AlterUniqueTogether(
            name="centosrepo", unique_together=set([("version", "arch", "prefix")])
        ),
        migrations.AddField(
            model_name="softwarecollection",
            name="centos_repos",
            field=models.ManyToManyField(
                to="scls.CentOSRepo", verbose_name="CentOS repos", blank=True
            ),
        ),
