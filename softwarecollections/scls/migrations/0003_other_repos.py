...
class Migration(migrations.Migration):
    ...
    dependencies = [("scls", "0002_centos_repos")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=20, verbose_name="Distribution name"),
                ),
                (
                    "version",
                    models.CharField(
                        max_length=20, verbose_name="Distribution version"
                    ),
                ),
                (
                    "variant",
                    models.CharField(
                        max_length=20, verbose_name="Variant", blank=True, default=""
                    ),
                ),
                ...
                (
                    "url",
                    models.CharField(
                        max_length=200, verbose_name="URL", blank=True, default=""
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        null=True, editable=False, verbose_name="Last modified"
                    ),
                ),
                (
                    "last_synced",
                    models.DateTimeField(
                        null=True, editable=False, verbose_name="Last synced"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="scls.OtherRepo", blank=True, verbose_name="Other repos"
            ),
        ),
        migrations.RunPython(migrate_centos_repos),
        migrations.RemoveField(model_name="softwarecollection", name="centos_repos"),
        migrations.DeleteModel(name="CentOSRepo"),
    ]
