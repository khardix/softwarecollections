...
LOGGING = {
    ...
    "loggers": {
        ...
        "django.request": {
            "handlers": ["console", "mail_admins"], "level": "ERROR", "propagate": True
        },
        "django.db.backends": {
            "level": DBDEBUG and "DEBUG" or "INFO", "propagate": True
        },
    },
}
...
AUTHENTICATION_BACKENDS = (
    "softwarecollections.auth.backend.PerObjectModelBackend", "fas.backend.FasBackend"
)
